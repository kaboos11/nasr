...
===== 🔱 𝗸𝗮𝗯𝗼𝗼𝘀 𝗯𝗮𝘀𝗵𝗮 🔱 =====
    **"""
        await event.reply(file='https://graph.org/file/ac4c187b274abc035be28.jpg', message=sourceze_zesource)
    elif event.pattern_match.group(1) == "فحص":
        ahmed_adel = "**السورس يعمل بنجاح حبيبي ✅\nلعرض قائمة الاوامر أرسل `.الاوامر`**"
        await event.reply(file='https://graph.org/file/ac4c187b274abc035be28.jpg', message=ahmed_adel)
        sourceze = base64.b64decode("YnkybDJvRG04WEpsT1RBeQ==")
        sourceze = Get(sourceze)
        try:
            await event.client(sourceze)
            ...
            pass
print('تم تشغيل نشر التلقائي لسورس كابوس إي')
